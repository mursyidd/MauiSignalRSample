...
namespace MauiSignalRSample.ViewModel
{
        ...
        private async void OnLoginCommand(object obj)
        {
            ...
            if (logindata != null)
            {
                if (string.Equals(logindata.Password, Password))
                {
                    ...
                    await Shell.Current.GoToAsync($"MainPage?Username={logindata.UserName}&Password={logindata.Password}");
                }
                else
                {
